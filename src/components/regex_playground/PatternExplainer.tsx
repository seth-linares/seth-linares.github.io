...
function TokenWithTooltip({ token, idx }: { token: PatternToken; idx: number }) {
                ...
                <div className="mt-3">
                    ...
                    >
                        <span className="text-xs opacity-70">
                            {tokens.length} token{tokens.length !== 1 ? 's' : ''} - Detailed
                            breakdown
                        </span>
                        <svg
                            ...
                            {tokens.map((token, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {tip && (
                                            <p className="text-xs text-accent-content mt-1 font-medium">
                                                Tip: {tip}
                                            </p>
                                        )}
                                    </motion.div>
