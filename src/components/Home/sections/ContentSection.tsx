...
const ContentSection = memo(({ isVisible, progress }: ContentSectionProps) => {
  const navigate = useNavigate();

  console.log('ContentSection rendering', { isVisible, progress });

  useEffect(() => {
    console.log('ContentSection: visibility changed to', isVisible);
  }, [isVisible]);
