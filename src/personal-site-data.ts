...
export const siteData: PersonalSiteData = {
    hero: {
        ...
        tagline:
            'Building secure, performant, and user-centric applications with a focus on system design and cryptography',
        cta: {
    ...
    about: {
        summary:
            "I'm a Computer Science graduate with a passion for building secure and efficient systems. My work spans from low-level Rust development to full-stack web applications, with a particular interest in cryptography, security, and developer tools.",
        highlights: [
        ...
        values: [
            {
                ...
                description:
                    'I believe in building applications with security as a fundamental requirement, not an afterthought',
            },
            {
                icon: 'cpu',
                title: 'Performance Matters',
                description:
                    'Optimizing for both user experience and system efficiency through thoughtful architecture',
            },
            {
                icon: 'heart',
    ...
    projects: [
        {
            ...
            description:
                'A zero-trust desktop password manager built with Rust and React, featuring military-grade encryption and complete offline operation',
            longDescription:
        ...
        },
        {
            ...
            description:
                'An interactive learning platform that combines code execution, AI coaching, and personalized feedback for programming education',
            technologies: [
                'C#',
                'ASP.NET',
                'NextJS',
        ...
        },
        {
            ...
            description:
                'A cross-platform terminal UI for quickly exploring repositories and selectively exporting file contents',
            longDescription:
                'RepoViewer solves a real problem I faced: efficiently sharing relevant parts of codebases. Built in Rust with Ratatui, it provides an intuitive way to navigate repositories, collect specific files, and export them with proper formatting.',
        ...
        },
        {
            ...
            description:
                "An exploration of how Vision Transformers process images, inspired by Andrej Karpathy's tokenizer series",
